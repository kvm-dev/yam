...
@Composable
fun SplashScreen(splashScreenViewModel: SplashScreenViewModel = koinViewModel(), onNavigateToHome: () -> Unit) {
    val viewModelState by splashScreenViewModel.progressState.collectAsState()
    when (viewModelState) {
        ProgressState.IDLE -> {
